...
static const HSV COLOUR_LAYERS[] = {
    { .h = 0x7C, .s = 0x67, .v = 0xD8 }, // teal
    { .h = 0x00, .s = 0x00, .v = 0xFF }, // white
    { .h = 0xEA, .s = 0x80, .v = 0xFF }  // pink
};
...
enum led_location_map {
    ...
    LED_A, // 9, A, k12
    LED_Z, // 10, Z, k14
    LED_LOPT, // 11, Win_L, k90
    LED_F2, // 12, F2, k36
    LED_2, // 13, 2, k27
    LED_W, // 14, W, k20
    LED_S, // 15, S, k22
    LED_X, // 16, X, k24
    LED_LCMD, // 17, Alt_L, k93
    LED_F3, // 18, F3, k31
    LED_3, // 19, 3, k37
    LED_E, // 20, E, k30
    LED_D, // 21, D, k32
